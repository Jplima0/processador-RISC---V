...
doc: Contém mais explicações sobre a implementação.

sim: Contém os arquivos de simulação e os resultados, para uso nos testes.
...
Manual de Conjunto de Instruções RISC-V Volume I: ISA de Nível de Usuário - Documento Versão 2.2
risc-v isa pages, by msyksphinz
...
Compare seus resultados com os exemplos fornecidos em sim
